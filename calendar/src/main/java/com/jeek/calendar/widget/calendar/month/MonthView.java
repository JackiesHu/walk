...
public class MonthView extends View {
    ...
    private void initAttrs(TypedArray array, int year, int month) {
        if (array != null) {
            ...
            mNormalDayColor = array.getColor(R.styleable.MonthCalendarView_month_normal_text_color, Color.parseColor("#232323"));
            ...
            mLastOrNextMonthTextColor = array.getColor(R.styleable.MonthCalendarView_month_last_or_next_month_text_color, Color.parseColor("#AAAAAA"));
            ...
            mLastOrNextMonthTextColor = Color.parseColor("#AAAAAA");
            mDaySize = 13;
        }
        mSelYear = year;
        mSelMonth = month;
