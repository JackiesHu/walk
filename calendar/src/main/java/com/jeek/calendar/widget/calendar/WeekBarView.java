...
public class WeekBarView extends View {
    ...
    /** week gray color */
    private int mWeekTextGrayColor;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mWeekTextColor = array.getColor(R.styleable.WeekBarView_week_text_color, getResources().getColor(R.color.calendar_week_bar_color));
        mWeekTextGrayColor = array.getColor(R.styleable.WeekBarView_week_text_gray_color, getResources().getColor(R.color.calendar_week_bar_gray_color));
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int i = 0; i < mWeekString.length; i++) {
            if (i == 0 || i == 6){
                mPaint.setColor(mWeekTextGrayColor);
            }else{
                mPaint.setColor(mWeekTextColor);
            }
            String text = mWeekString[i];
            int fontWidth = (int) mPaint.measureText(text);// Return the width of the text.
