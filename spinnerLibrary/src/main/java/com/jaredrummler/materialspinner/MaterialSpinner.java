...
public class MaterialSpinner extends TextView {
  ...
  private MaterialSpinnerListener mMaterialSpinnerListener;

  public void setOnMaterialSpinnerListener(MaterialSpinnerListener materialSpinnerListener) {
    mMaterialSpinnerListener = materialSpinnerListener;
  }
...
//    }
    ...
    listView.setMinimumHeight((int) (getResources().getDisplayMetrics().density * 60));
...
//      int x = location[0];
//      int y = getHeight() + location[1]-20;
//      popupWindow.showAtLocation(this, Gravity.TOP | Gravity.START, x, y);
//    }

    if(mMaterialSpinnerListener!=null){
      int[] location = new int[2];
      getLocationOnScreen(location);
//      int x = location[0];
      int x = mMaterialSpinnerListener.getSuperLocationOnScreen()[0];
      int y = (int) (getHeight() + location[1]- getResources().getDisplayMetrics().density * 3.0);
      popupWindow.showAtLocation(this, Gravity.TOP | Gravity.START, x, y);
