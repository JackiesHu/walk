package com.buxingzhe.pedestrian.http.imageupload;
...
/**
 * Created by QJ on 2017/4/21.
 */

public class UploadImage_a {
...
//            split.append("Content-Disposition: form-data; name=\"" + file.getFormName() + "\"; filename=\"" + file.getFileName() + "\"" + lineEnd);
            split.append("Content-Disposition: form-data; name=\"bannerUrl\";filename=" + "\"" + file.getName() + "\"" + lineEnd);
            split.append("Content-Type: image/jpg" + lineEnd);
            split.append(lineEnd);
            try {
                // 发送图片数据
                output.writeBytes(split.toString());
//                output.write(file., 0, file.getData().length);
...
//            sb.append("Content-Disposition: form-data; name=\"bannerUrl\";filename=" + "\"" + file.getName() + "\"" + lineEnd);
            sb.append("Content-Disposition: form-data; name=\"bannerUrl\";filename=" + "\"" + lineEnd);
            sb.append(lineEnd);
     ...
     * @return 返回请求结果
     */
    public String post(String actionUrl,Map<String, String> params, File[] files) {
