...
public class UploadImage {
     ...
     * @return 返回响应的内容
     */
    public static String uploadFile(File file, Map<String, String> paramsMap, String requestURL) {
        try {
...
//                String[] values = {"1410065922", file.getName(), "jpg", "dfbe0e1686656d5a0c8de11347f93bb6", "e70cff74f433ded54b014e7402cf094a"};
                ...
                String[] values = new String[paramsMap.size()];
                if (paramsMap != null) {
                    int count = 0;
...
//                sb.append("Content-Disposition: form-data; name=\"data\";filename=" + "\"" + file.getName() + "\"" + LINE_END);
                sb.append("Content-Disposition: form-data; name=\"bannerUrl\";filename=" + "\"" + file.getName() + "\"" + LINE_END);
